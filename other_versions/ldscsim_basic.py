...
@typecheck(mt=MatrixTable, 
           ...
           popstrat=nullable(expr_int32,
                             expr_float64))
def simulate_phenotypes(mt, genotype, h2, pi=1, rg=None, annot=None, popstrat=None):
    ...
    mt = annotate_all(mt=mt,
                      ...
                      global_exprs={'ldscsim':hl.struct(**{**{'h2':[0.5,0.3]},
...
def annotate_all(mt,row_exprs={},col_exprs={},entry_exprs={},global_exprs={}):
    ...
    mt = mt._annotate_all(row_exprs, col_exprs, entry_exprs, global_exprs)

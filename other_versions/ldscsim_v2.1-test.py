...
#    print(sim_mt.aggregate_cols(hl.agg.stats(sim_mt.__y)))
#    print(sim_mt.aggregate_cols(hl.agg.stats(sim_mt.__y_w_popstrat)))
...
#    mt = mt.annotate_cols(popstrat = ht0[mt.s]['PC1']*ht0[mt.s]['PC2'])
#    test_suite(mt=mt, genotype=mt.GT.n_alt_alleles(), popstrat=mt.popstrat)
